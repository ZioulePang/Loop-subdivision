...
RenderWindow::RenderWindow
    ...
    writeNewFiles				= new QCheckBox					("Write Files",		this);
    // spatial sliders
    ...
    vertexVolumnSlider          = new QSlider                   (Qt::Horizontal,        this);
    ...
    vertexVolumnLabel	        = new QLabel					("Vertex Volumn",	    this);
    ...
    windowLayout->addWidget(writeNewFiles,	            6,          3,          1,          1           );
    ...
    windowLayout->addWidget(vertexVolumnSlider,			nStacked+2,	1,			1,			1			);
    windowLayout->addWidget(vertexVolumnLabel,			nStacked+2,	3,			1,			1			);
...
void RenderWindow::ResetInterface()
    ...
    writeNewFiles   	    ->setChecked        (renderParameters   ->  writeFiles);
    // set sliders
    ...
    vertexVolumnSlider		->setMinimum		(0);
    vertexVolumnSlider		->setMaximum		(3);
    vertexVolumnSlider		->setValue			(int(renderParameters -> vertexVolumn));
    ...
    vertexVolumnSlider      ->update();
    showVerticesBox		    ->update();
    flatNormalsBox		    ->update();
    writeNewFiles		    ->update();
    } // RenderWindow::ResetInterface()
